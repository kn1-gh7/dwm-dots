...
static const char *fonts[]          = { "JetBrainsMonoNerdFont:size=14", "SymbolsNerdFont:size=14" };
...
static const char col_fg1[]         = "#ddc7a1";
static const char col_bg0[]         = "#1d2021";
static const char col_bg1[]         = "#282828";
static const char col_bg2[]         = "#3c3836";
static const char col_bg3[]         = "#504945";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray0, col_bg0, col_bg1 },
	[SchemeSel]  = { col_fg1, col_bg0,  col_fg1  },
};
